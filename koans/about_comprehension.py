...
class AboutComprehension(Koan):
    ...
    def test_creating_lists_with_list_comprehensions(self):
        ...
        # list comprehension creates a new list based on a pre-existing list and custom settings
    ...
    def test_double_list_comprehension(self):
        ...
        # double list comp will create a list with each possible combination
    ...
    def test_creating_a_set_with_set_comprehension(self):
        ...
        # set comp works like list comp but with the rules of a set
