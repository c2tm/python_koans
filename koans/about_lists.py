...
class AboutLists(Koan):
    def test_creating_lists(self):
        ...
        # tests if a list was created with length 0
    ...
    def test_list_literals(self):
        ...
        self.assertListEqual([1, 2], nums)  # tests if 2 was added to nums

        nums.append(333)
        # self.assertListEqual([1, 2, __], nums)
        # tests if 333 was appended to nums
    ...
    def test_slicing_lists(self):
        ...
        # slicing out of range does not error out, list[start, end(exclusive)]
    ...
    def test_slicing_to_the_edge(self):
        ...
        # shows how to slice everything before or after an index
    ...
    def test_lists_and_ranges(self):
        ...
        # last number in range is not inclusive. returns a list of numbers up to specified number. can specify starting number
    ...
    def test_ranges_with_steps(self):
        ...
        # last input in range is optional, sets incrementation
    ...
    def test_popping_lists(self):
        ...
        # pop removes the last value of a list unless you specify an index
    ...
    def test_making_queues(self):
        ...
        # Not sure what the takeway from this example is, researched queues
        # and understand how they work regardless. They use first in first out
        # concept and maintain order
