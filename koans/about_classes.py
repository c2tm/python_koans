...
class AboutClasses(Koan):
    ...
    def test_classes_have_docstrings(self):
        ...
        #instances of classes can be constructed from a class
    ...
    #I understand how they use init as a constructor and make methods for instances of the class.
    #Im not understanding __dict__ example
    ...
    #set.___(___) can set properties to instances of classes
    ...
    def test_creating_properties_with_decorators_is_slightly_easier(self):
        ...
        #fido.___ can create properties
    ...
    #     self.assertEqual(fido.__repr__(), fido.get_self())  # Not a string!

    #Not sure at the time im doing this, will look into at later time

    def test_str_provides_a_string_version_of_the_object(self):
        fido = self.Dog6("Fido")

        self.assertEqual("{self.name}", str(fido))

    def test_str_is_used_explicitly_in_string_interpolation(self):
        fido = self.Dog6("Fido")

        self.assertEqual("My dog is {self.name}", "My dog is " + str(fido))
    ...
    def test_all_objects_support_str_and_repr(self):
        ...
        #Difference between str and repr is str returns a string of whatever is passed in
        #While repr returns a string of exactly was passed in ("STRING" vs "'STRING'")
